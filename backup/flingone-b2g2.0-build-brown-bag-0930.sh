#!/bin/bash
TARGET_BRANCH="${TARGET_BRANCH-flingone-brown-bag-0930}"
...
cd $SRC_DIR
GITREPO='appler:flingone/b2g-manifest' BRANCH=infthink/brown-bag-0930 REPO_INIT_FLAGS='--repo-url=appler:tools/repo.git' ./config.sh -d rk30sdk >> repo.log 2>&1
